                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <label>Volume</label>
                                                <input type="text" class="form-control" name="volume" id="volume" value="{{$belanja->volume}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <!-- text input -->
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nominal_belanja" id="nominal_belanja" value="{{$belanja->nominal_belanja}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="no_pbb_ls" id="no_pbb_ls" value="{{$belanja->rincian_belanja}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <!-- text input -->
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input" name="tanggal_belanja" data-target="#reservationdate" value="{{$belanja->tanggal_belanja}}"/>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="reservationdate1" data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input" name="tanggal_sp2d" data-target="#reservationdate1" value="{{$belanja->tanggal_sp2d}}"/>
